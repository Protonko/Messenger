...
import {
  MessageActionsTypes,
  CreateMessageAction, CreateMessageErrorAction, CreateMessageSuccessAction,
...
export const createMessageSuccess = (payload: Omit<ICreateMessageResponse, 'status'>): CreateMessageSuccessAction =>
  ({type: MessageActionsTypes.CREATE_MESSAGE_SUCCESS, payload})

export const createMessageError = (payload: string): CreateMessageErrorAction =>
